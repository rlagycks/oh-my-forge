...
2. **Start listener**: `VIDEODB_EVENTS_DIR="$STATE_DIR" python "${CLAUDE_PLUGIN_ROOT:-${CODEX_PLUGIN_ROOT:-$(cat "$HOME/.claude/.omf-root" 2>/dev/null || echo "$HOME/.claude")}}/skills/videodb/scripts/ws_listener.py" --clear "$STATE_DIR" &`

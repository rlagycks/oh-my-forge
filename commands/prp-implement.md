...
4. **Track progress** — Log: `PASS: Task N: [task name] — complete`
...
| # | Task | Status | Notes |
|---|---|---|---|
| 1 | [task name] | PASS: Complete | |
| 2 | [task name] | PASS: Complete | Deviated — [reason] |
...
| Unit Tests | PASS: Pass | N tests written |
| Build | PASS: Pass | |
| Integration | PASS: Pass | or N/A |

---
description: Analyze a draft prompt and output an optimized, OMF-enriched version ready to paste and run. Does NOT execute the task — outputs advisory analysis only.
---

# /prompt-optimize

Analyze and optimize the following prompt for maximum OMF leverage.
...
3. **OMF Component Matching** — Map to specific skills, commands, agents, and model tier
...
- Present diagnosis, recommended OMF components, and an optimized prompt using the Output Format from the prompt-optimizer skill
